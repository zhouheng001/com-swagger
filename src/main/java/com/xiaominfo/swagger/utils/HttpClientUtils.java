package com.xiaominfo.swagger.utils;
...
public class HttpClientUtils {
	 ...
	 * @return
	 */
	public static ResponseJSON getResult(HttpServletRequest request){
		...
		ResponseJSON responseJSON = JSON.parseObject(content, ResponseJSON.class);
		return responseJSON;
	}
	 ...
	 * @return
	 */
	public static ResponseJSON postResult(HttpServletRequest request){
		StringBuffer requestURL = request.getRequestURL();
		Map<String, String> headers = HttpClientUtils.getHeaders(request);
		Map<String, String> parameterMap = HttpClientUtils.getParameters(request);
		String host = request.getHeader("host");
